    ...
    <div className="animate-fade-in bg-white min-h-screen pt-12">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-8 md:col-start-4">
          {/* Render content with fallback for plain text */}
          {blog.content.includes('<') ? (
            ...
            <div className="prose prose-lg prose-headings:font-serif prose-headings:font-medium prose-headings:text-anvitam-charcoal prose-p:text-gray-600 prose-p:font-serif prose-p:leading-loose prose-a:text-anvitam-blue prose-img:rounded-sm max-w-none">
              {blog.content.split(/\n\s*\n/).map((paragraph, index) => (
